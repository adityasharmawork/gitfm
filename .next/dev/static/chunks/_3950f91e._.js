...
function StoryModeVideo({ data }) {
    ...
    const spawnParticles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoryModeVideo.useCallback[spawnParticles]": (x, y, color, count = 10, type = "spark")=>{
            for(let i = 0; i < count; i++){
                const angle = Math.random() * Math.PI * 2;
    ...
    }["StoryModeVideo.useCallback[spawnParticles]"], []);
    // --- Drawing Helpers ---
    ...
    const preview = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "StoryModeVideo.useCallback[preview]": ()=>{
            if (isPlayingRef.current) return;
            setStatus("playing");
            isPlayingRef.current = true;
            let f = 0;
            const loop = {
                "StoryModeVideo.useCallback[preview].loop": ()=>{
                    if (!canvasRef.current || !isPlayingRef.current) {
...
_s(StoryModeVideo, "9Vjpci4dF18JqO7j0ZiB788m/pE=");
_c = StoryModeVideo;
var _c;
...
//# sourceMappingURL=_3950f91e._.js.map